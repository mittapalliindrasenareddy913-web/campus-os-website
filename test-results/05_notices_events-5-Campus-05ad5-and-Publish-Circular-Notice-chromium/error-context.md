...
- Name: 05_notices_events.spec.ts >> 5. Campus Notices & Academic Calendar Events >> Notices: Create and Publish Circular Notice
- Location: e2e\specs\05_notices_events.spec.ts:13:3
...
Call log:
  - waiting for locator('button:has-text("Notices"), [data-tab="notices"]').first()
