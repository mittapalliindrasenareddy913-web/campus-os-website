...
- Name: 01_auth_rbac.spec.ts >> 1. Authentication & RBAC Privilege Verification >> RBAC Elevation Guard: Principal role access verification
- Location: e2e\specs\01_auth_rbac.spec.ts:28:3
...
Received string:  "http://localhost:5175/login/principal"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    23 × locator resolved to <html lang="en">…</html>
       - unexpected value "http://localhost:5175/login/principal"
