...
- Name: 03_management_crud.spec.ts >> 3. HOD, Faculty, Student & Department CRUD Operations >> Department Management: Create Department
- Location: e2e\specs\03_management_crud.spec.ts:16:3
...
Call log:
  - waiting for locator('button:has-text("Departments"), [data-tab="departments"]').first()
