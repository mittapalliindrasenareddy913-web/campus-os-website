...
- Name: 03_management_crud.spec.ts >> 3. HOD, Faculty, Student & Department CRUD Operations >> Faculty Roster: Add new faculty member
- Location: e2e\specs\03_management_crud.spec.ts:32:3
...
Call log:
  - waiting for locator('button:has-text("Faculty"), [data-tab="faculty"]').first()
