...
- Name: 07_network_console_resilience.spec.ts >> 7. Browser Console Error & Network Failure Resilience >> Monitor Network API failures (status >= 400)
- Location: e2e\specs\07_network_console_resilience.spec.ts:24:3
