...
- Name: 07_network_console_resilience.spec.ts >> 7. Browser Console Error & Network Failure Resilience >> Monitor for zero uncaught JavaScript console errors
- Location: e2e\specs\07_network_console_resilience.spec.ts:7:3
...
Call log:
  - waiting for locator('button:has-text("Overview"), [data-tab="overview"]').first()
