...
- Name: 05_notices_events.spec.ts >> 5. Campus Notices & Academic Calendar Events >> Calendar: Academic Event Display
- Location: e2e\specs\05_notices_events.spec.ts:24:3
...
Call log:
  - waiting for locator('button:has-text("Calendar"), [data-tab="calendar"]').first()
